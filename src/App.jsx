...
function App() {
  ...
  const { data, loading, error } = useFetch( `https://api.openweathermap.org/data/2.5/weather?q=${query}&appid=8ac5c4d57ba6a4b3dfcf622700447b1e&units=metric`);
  ...
  return (
    <div style={{ width: "100%", minHeight: "90vh" }}  className="weather-app container d-flex flex-column justify-content-center align-items-center ">
        ...
        <h1 className=" fw-bolder fs-1 text-center text-success">Weather App</h1>
        ...
        {data && (
          <div className="weather-details">
            <h2 className="fw-bolder text-dark">Weather in {data.name}</h2>
